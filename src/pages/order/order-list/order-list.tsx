...
const OrderList: React.FC = () => {
  ...
  const columns: TableProps<any>['columns'] = [
    ...
    },
    {
      ...
      dataIndex: 'orders',
      render: (productList) => {
        if (!Array.isArray(productList) || !productList.length) { //ktra danh sach co phai mảng rỗng hoặc ko phải mảng
          return null;
        }
        return (
  ...
  return (
    <TableStyle>
      ...
      />
      <div className="flex justify-end mt-10">  {/*danhsốtrangởcuối*/}
